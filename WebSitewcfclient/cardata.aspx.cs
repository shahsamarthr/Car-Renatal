...
public partial class cardata : System.Web.UI.Page
{
    ...
    //    ServiceReference1.car car1 = proxy.GetCar(ListBox1.SelectedIndex);
    //    Label1.Text = car1.carname;
    //    Label2.Text = car1.cartype;
    //    Label3.Text = car1.carnum;
    ...
    //    Console.WriteLine(ListBox1.SelectedItem.Value.ToString());
    //    Console.WriteLine("text"); 
    //    Console.WriteLine(ListBox1.SelectedIndex.ToString());
    //   ServiceReference1.car car1 = proxy.GetCar((ListBox1 .SelectedIndex)-1);
    //    Label1.Text = car1.carname;
    //    Label2.Text = car1.cartype;
    //    Label3.Text = car1.carnum;
